...
import { CustomerLogos } from '@/components/home-service/CustomerLogos';
                    ...
                    <section className="w-full max-w-5xl mx-auto px-5 pt-12 pb-16 md:pt-20 md:pb-28 relative">
                        ...
                        <div className="flex flex-col items-center text-center relative z-10">
                            ...
                            <motion.p
                                ...
                                className="inline-flex items-center gap-2 text-sm md:text-base text-white/80 mb-6 font-medium px-4 py-2 rounded-full bg-white/5 border border-white/10"
                            >
                                <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
                                Works <span className="text-emerald-400 font-semibold">24/7</span> for just <span className="text-white font-bold">$6/day</span>
                            </motion.p>
