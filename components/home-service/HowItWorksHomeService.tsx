...
const steps = [
    {
        ...
        description: "Link your business line. Takes 2 minutes, no tech skills needed.",
    ...
    },
    {
        ...
        description: "Services, pricing, service area, appointment types. Plain English.",
    ...
    },
    {
        ...
        description: "AI handles calls, texts, and web leads. Your calendar fills up.",
...
export function HowItWorksHomeService() {
    return (
            ...
            <div className="max-w-5xl mx-auto relative z-10">
                ...
                >
                    ...
                    <h2 className="text-3xl md:text-5xl font-bold text-white mb-5">
                        Live before your <span className="bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent">next job site</span>.
                    </h2>
                    <p className="text-gray-400 text-lg max-w-xl mx-auto">No coding required. Set up between jobs.</p>
                </motion.div>
