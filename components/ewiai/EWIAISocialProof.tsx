...
export function EWIAISocialProof() {
    return (
        <section className="w-full py-16 border-y border-white/[0.04] bg-gradient-to-b from-[#0a0b1e]/50 to-[#0a0b1e] backdrop-blur-sm relative overflow-hidden">
                        ...
                        <div key={index} className="contents">
                            ...
                            >
                                <div className="relative inline-block">
                                    {stat.highlight && (
                                        <div className="absolute -inset-4 bg-blue-500/10 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                                    )}
